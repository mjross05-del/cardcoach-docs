...
- `CardCoach_Phase4_Revenue_Model_v2.xlsx` — the live revenue model (866 formulas). The PDFs were renders of it.
- The **audit workbook** (.xlsx) — needed to verify card-level facts (earn rates, caps, values).
