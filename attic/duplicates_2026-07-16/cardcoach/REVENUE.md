...
> **The model itself lives in a spreadsheet that IS in this project, at root:**
> `CardCoach_Phase4_Revenue_Model_v2.xlsx` (materialized 2026-06-09; 7 tabs / 866 formulas
> verified, editable inputs). The two PDFs were renders of it. To flex assumptions, edit the
> `.xlsx`; `CardCoach_Phase4_Sensitivity_OnePager.md` is its current summary output. This
> doc captures the numbers and logic, not the live model.
...
5. **App Store listing copy and submission** — Alex's lane entirely. The "free web, premium mobile companion" narrative bridge still needs to appear in the website CTA (Mike's lane, site copy currently paused).

---

*The numbers here are a snapshot of the v2 model as of May 2026. To change assumptions, use
`CardCoach_Phase4_Revenue_Model_v2.xlsx` — the live workbook IS in this project, at root
(materialized 2026-06-09; 7 tabs / 866 formulas verified), with
`CardCoach_Phase4_Sensitivity_OnePager.md` as its current summary output. If revenue
